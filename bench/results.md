...
Generated by `bench/run_bench.ps1` on 2026-09-03 22:09. Do not edit by hand.
...
Startup floor (an empty program, best of 5): Goose 13.5 ms / 7.9 MB, C++ 13.0 ms / 7.9 MB.
...
| lru | 2.88x | 4.18x | 0.74x | 1.06x | 0.69x | 1.05x | 3.16x | 1.36x | 1.03x |
...
| **geometric mean** | **3.27x** | **3.25x** | **1.15x** | **1.16x** | **1.04x** | **1.10x** | **1.87x** | **1.27x** | **1.21x** |
...
| lru | goose reusable pool + pool-relative refs | 3,254.7 | 2,133.3 | 1.53 |
...
| lru | cpp arena + open addressing | 2,413.3 | 2,260.6 | 1.07 |
